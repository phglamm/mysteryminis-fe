...
import { EnvironmentOutlined, GiftOutlined, GithubOutlined, ProfileOutlined } from "@ant-design/icons";
...
const Sidebar = ({ setActiveSection }) => {
    ...
    const sections = [
        { icon: <ProfileOutlined />, title: "My Profile", description: "Manage your information" },
        { icon: <EnvironmentOutlined />, title: "Address Book", description: "Manage your address" },
        { icon: <GiftOutlined />, title: "Earned Rewards", description: "View your rewards" }
    ];
        ...
        <div className="pl-4 pt-4 pb-4 pr-2">
            <div className="h-fit bg-gray-100 rounded-xl p-4">
                <div className="border-b-1 border-gray-300 pb-4">
                    ...
                    <div className="flex justify-center mb-2 text-5xl"> <GithubOutlined /> </div>
                        ...
                        <div key={index} className="border-t-1 border-gray-300 pt-4">
                            ...
                            >
                                ...
                                <div className="flex flex-col">
                                    <div className="font-extrabold text-[0.9vw]">{section.title}</div>
