...
const AddressPOST = ({ setAddAddress }) => {
    ...
    const fetchDistricts = async (provinceId) => {
        try {
            ...
            if (response.data.code === 200) {
                const filteredDistricts = response.data.data.filter(d => d.ProvinceID === provinceId);
                    ...
                    <Select
                        ...
                        onChange={(value) => {
                            ...
                            setFormData((prev) => ({
                                ...prev,
                                provinceId: value,
                                provinceName: selectedProvince ? selectedProvince.ProvinceName : null, // Lưu thêm Province Name
                    ...
                    <Select
                        ...
                        onChange={(value) => {
                            ...
                            setFormData((prev) => ({
                                ...prev,
                                districtId: value,
                                districtName: selectedDistrict ? selectedDistrict.DistrictName : null, // Lưu thêm District Name
                                wardCode: null,
                                wardName: null
                            }));
                            fetchWards(value);
                    ...
                    <Select
                        ...
                        onChange={(value) => {
                            ...
                            setFormData((prev) => ({
                                ...prev,
                                wardCode: value,
                                wardName: selectedWard ? selectedWard.WardName : null // Lưu thêm Ward Name
                            }));
                        }}
