...
import { Table, Button, Space, Modal, Input, Form, message, Switch, Tooltip, Spin } from "antd";
...
//   const [form] = Form.useForm();
  ...
  const columns = [
    { title: "ID", dataIndex: "feedbackId", key: "feedbackId", width: 80 },
    {
      ...
      width: 300,
      render: (text) => {
        const truncatedText = text.length > 10 ? `${text.substring(0, 80)}...` : text;
        return (
          <Tooltip title={text}>
    ...
    { title: "Box Option Name", dataIndex: "boxOptionName", key: "boxOptionName", width: 150 },
    { title: "Image", dataIndex: "imageUrl", key: "imageUrl", render: (text) => <img src={text} alt="Feedback Image" style={{ width: "50px", height: "50px" }} />, width: 100 },
    { title: "Box Option ID", dataIndex: "boxOptionId", key: "boxOptionId", width: 120 },
    {
        title: "Created At",
        dataIndex: "createdAt",
        key: "createdAt",
