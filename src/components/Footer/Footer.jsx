        ...
        {footerSections.map((section, index) => (
          <div
            ...
            className={`flex flex-col justify-center items-center text-center ${
              section.span ? `col-span-${section.span}` : ""
            }`}
          >
            {section.isLogo ? (
              <>
                <img
                  src={Logo}
                  alt="Logo"
                  className="w-[20vw] max-w-[280px] h-fit mb-2"
                />
                <div className="text-[2.5vw] font-bold">Mystery Minis</div>
              </>
            ) : (
              <>
                <div className="font-bold flex justify-center text-[1.6vw] mb-4 whitespace-nowrap ">
                  {section.title}
                </div>
